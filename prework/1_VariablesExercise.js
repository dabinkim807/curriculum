...
/* The rule for num1 allows values from 1 to 10, exclusive, while the rule for num2 allows values from 1 to 10, inclusive.
   In other words, all possible values for num2 are all the possible values of num1, in addition to values 1 and 10. */
...
// In Exercise 5, num1 has already been assigned the value of 4;
num2 = 6;
...
// I found this exercise easy. I used the console on Google Chrome.
